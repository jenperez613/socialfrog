export const menu = [
    {
        name: "Campus",
        icon: "campus",
        description: "A unique, exclusive space for college students on frogBook.",
    },
    {
        name: "Events",
        icon: "events",
    ...
    },
    {
        name: "Find Friends",
        icon: "friends",
        description: "Search for friends or amphibians you may know.",
    },
    {
        name: "Groups",
        icon: "groups",
        description: "Connect with frogs and toads who share your interests.",
    },
    {
        name: "News Feed",
        icon: "feed",
        description: "See relevant posts from amphibians and Pages you follow.",
    },
    {
        name: "Pages",
        icon: "pages",
        description: "Discover and connect with businesses on frogBook.",
    },
    {
        name: "Gaming Video",
        icon: "gaming",
    ...
    },
    {
        ...
        icon: "recent",
        description: "See all the ads you interacted with on frogBook.",
    },
    {
        name: "Memories",
        icon: "memories",
        description: "Browse your old photos, videos and posts on frogBook.",
    },
    {
        name: "Saved",
        icon: "saved",
